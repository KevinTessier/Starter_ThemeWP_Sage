<nav id="access-fast" role="navigation" aria-label="Menu d'accès rapide">
  <ul class="list-none">
    <li class="list-none"><a href="#primary-menu" title="Accèder au menu principal">Menu principal</a></li>
